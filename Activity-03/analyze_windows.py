...
def win_tasks():
    ...
    try:
        ...
        print("❌ Could not query scheduled tasks. Run as administrator.")
        return
    import csv
    import io
...
def win_startup():
    ...
    try:
        ...
        print("❌ Access denied to registry. Try running as administrator.")
        return
    except FileNotFoundError:
